# YEW design notes and execution record

The rules the code fixed while it was built, phase by phase, with the evidence. The README is
the developer guide; this file is where a rule's *why* lives. Phase numbers (W1–W6) are the
work plan's, `docs/plans/yellowback-wallet-plan.md` in the `yellowback-workspace` repository.

## Core modules and their sources
...
## W5 — hardening and release preparation
...
## Devnet acceptance runs (W1, W2, W4)
